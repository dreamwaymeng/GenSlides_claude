...
%==============================================================================
% SLIDE 2: Why Exotic Hadrons Matter
%==============================================================================
\begin{frame}{Why Exotic Hadrons Matter}
\begin{columns}[T]
\begin{column}{0.55\textwidth}
\textbf{QCD: The Unsolved Theory}
\begin{itemize}
    \item Strong force governs nuclear matter
    \item \textbf{Confinement} remains poorly understood
    \item Quarks never observed in isolation --- why?
\end{itemize}

\vspace{0.5em}
\textbf{Exotic Hadrons as Probes:}
\begin{itemize}
...
\vspace{0.5em}
\textbf{This Work:} \\
Study $T_{cc}$, $T_{bb}$, $T_{4c}$, $T_{4b}$, and triply heavy pentaquarks $QQqq\bar{Q}$
\end{column}
...
%==============================================================================
% SLIDE 10: DeepQuark Wave Function (merged from encoding + symmetry)
%==============================================================================
...
\begin{itemize}
    \item $f_{NN}(\boldsymbol{x})$: Neural network outputs wave function amplitude
    \item $\mathcal{A}[\cdots]$: Antisymmetrization (Fermi-Dirac statistics)
...
\end{equation*}
{\small Spatial + color + spin + isospin (one-hot encoded)}
\end{column}
\begin{column}{0.48\textwidth}
\textbf{Coupled Basis Approach:}
\begin{itemize}
    \item Color-spin-isospin bases (not single-particle orbitals)
...
\begin{itemize}
    ...
    \item Efficient for strongly correlated systems
\end{itemize}

{\small (See backup for detailed color basis formulas)}
\end{column}
\end{columns}
\end{frame}
...
%==============================================================================
% SLIDE 13: Benchmarks and Performance
%==============================================================================
...
\vspace{0.3em}
\textbf{Unique Capability:}
\begin{itemize}
    \item Handles \textbf{flux-tube confinement}
    \item GEM cannot do this efficiently!
\end{itemize}

\vspace{0.3em}
\centering
\includegraphics[width=0.7\textwidth]{arXiv-2506.20555v1/qqqFT.pdf}

{\scriptsize Pairwise vs.\ flux-tube confinement}
...
%==============================================================================
% SLIDE 16: T4c - A Laboratory for Confinement
%==============================================================================
\begin{frame}{$T_{4c}$: A Laboratory for Confinement}
\begin{columns}[T]
\begin{column}{0.48\textwidth}
\textbf{Why $T_{4c}$ Is Special:}
\begin{itemize}
    \item \textbf{Pure QCD system} --- no light quark chiral effects
    \item Short-range gluon exchange dominates
    \item Ideal testbed for \textbf{confinement mechanisms}
\end{itemize}

\vspace{0.3em}
\textbf{Experimental Motivation:}
\begin{itemize}
...
\end{column}
\begin{column}{0.48\textwidth}
\textbf{Why DeepQuark Can Calculate It:}

\vspace{0.2em}
\textcolor{red}{\textbf{Challenge:}} Flux-tube confinement
\begin{itemize}
...
\vspace{0.3em}
\textcolor{heavyblue}{\textbf{DeepQuark Solution:}}
\begin{itemize}
...
%==============================================================================
% SLIDE 17: Fully Heavy Tetraquarks
%==============================================================================
...
\vspace{0.3em}
DeepQuark is \textbf{uniquely positioned} to explore these questions!
\end{column}
\begin{column}{0.48\textwidth}
\textbf{Experimental Synergy:}
\begin{itemize}
...
\begin{itemize}
    ...
    \item Structure (molecular vs.\ compact) reveals color dynamics
    \item DeepQuark: first-principles, unbiased predictions
